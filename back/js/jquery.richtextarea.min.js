...
richtextarea = function () {
    ...
    this.navigationPath = [];
    this.navBar = null;
    this.options = { indentTab: true, tabCode: true, mode: JQE_MODE_VIEW, onChange: function () {}, toolbar: true, navigationPath: false };
    ...
    this.initEditor = function (a) {
        ...
        if (this.nodeName == "textarea") {
            ...
            if (this.options.toolbar) {
                ...
                RichTextArea += '<a class="ui-richtextarea-button ui-state-default" unselectable="on"><span class="ui-richtextarea-icon-bold ui-richtextarea-icon">Bold</span></a>';
                RichTextArea += '<a class="ui-richtextarea-button ui-state-default" unselectable="on"><span class="ui-richtextarea-icon-italic ui-richtextarea-icon">Italic</span></a>';
                RichTextArea += "</div>";
            }
    ...
    this.setNavigationPath = function () {
        ...
        for (i = this.navigationPath.length - 1; i > -1; i--) {
            if (this.navigationPath[i].nodeType != 3) {
                jQuery(this.navBar).append('<a class="ui-richtextarea-nav' + i + ' ui-state-default" unselectable="on"><span>' + this.getNodeName(this.navigationPath[i]) + "</span></a>");
                navButton = jQuery(this.navBar)
                    .find(".ui-richtextarea-nav" + i)
                    .get(0);
    ...
    this.insertHtml = function (b, a, c) {
